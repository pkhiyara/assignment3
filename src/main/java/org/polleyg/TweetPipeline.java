...
public class TweetPipeline {
    private static final String TOPIC = "projects/assignment3-276800/topics/assignment3";
    private static final String BIGQUERY_DESTINATION = "assignment3-276800:twitter.tweets";
